        ...
        <div>
            <div className='flex justify-between'>
                <div className="flex gap-1 items-center">
                    <h1 className="font-geo text-lg dark:text-slate-200">Members</h1>
                    <p className="font-geo text-sm bg-stone-100 rounded-full py-0.5 px-2 text-center">{allMembers.length}</p>
                </div>
                <button className='flex gap-1 items-center border rounded-3xl py-2.5 px-3.5 dark:border-slate-800'>
