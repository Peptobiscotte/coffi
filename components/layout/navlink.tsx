    ...
    return (
            <nav>
                <ul  className="flex md:flex-col gap-1 font-geo text-slate-400">
                    <li className={pathName === '/' ? 'flex gap-3 px-3 py-2 bg-stone-50 rounded-lg' : 'flex gap-3 px-3 py-2'}>
                        <Image src={homeSvg} alt="home svg" className="max-sm:hidden"/>
                        <Link href='/' className={pathName === '/' ? 'text-indigo-500' : ""}>Home</Link>
                    </li>
                    <li className={pathName.includes('/members') ? 'flex gap-3 px-3 py-2 bg-stone-50 rounded-lg' : 'flex gap-3 px-3 py-2'}>
                    ...
                    <li className={pathName.includes('/venue') ? 'flex gap-3 px-3 py-2 bg-stone-50 rounded-lg' : 'flex gap-3 px-3 py-2'}>
                    ...
                    <li className={pathName === '/agenda' ? 'flex gap-3 px-3 py-2 bg-stone-50 rounded-lg' : 'flex gap-3 px-3 py-2'}>
